...
from dataset import KoT5SumInferDataset, KoBigbirdMovieDataset


class KcElectradModel(LightningModule):
    ...
    def _loader(self, data_config, split):
        ...
        #                                split=split)
        dataset = KoT5SumInferDataset(data_dir=data_config.data_dir,
                                        tokenizer=self.tokenizer,
                                        max_length=self.max_length,
                                        split=split)
